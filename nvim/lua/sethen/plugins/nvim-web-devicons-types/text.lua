...
local textIcon = '󰈙 '
local textXmlIcon = ' '
local textColor = palette.sapphire
local textYellowColor = palette.yellow
local textGrayColor = palette.overlay2
...
return {
    ...
    xml = { icon = textXmlIcon, name = 'Xml', color = textColor },
    ...
    ['favicon.ico'] = { icon = textIcon, name = 'Favicon', color = textYellowColor },
    ['README.md'] = { icon = textIcon, name = 'Readme', color = textGrayColor },
}
