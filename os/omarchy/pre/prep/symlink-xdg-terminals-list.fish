...
function symlink-xdg-terminals-list
    ...
    # something other than kitty. see the comments in the list itself.
    make-symlink $DOTFILES_DIRECTORY/xdg/xdg-terminals.list $HOME_CONFIG_DIRECTORY/xdg-terminals.list
end
