...
_G.packer_plugins = {
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/sethen/.local/share/nvim/site/pack/packer/start/coc.nvim"
  },
  ["emmet-vim"] = {
    loaded = true,
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/sethen/.local/share/nvim/site/pack/packer/start/vim-go"
  },
  ["vim-hexokinase"] = {
    loaded = true,
    path = "/home/sethen/.local/share/nvim/site/pack/packer/start/vim-hexokinase"
  },
  ["vim-javascript"] = {
    loaded = true,
