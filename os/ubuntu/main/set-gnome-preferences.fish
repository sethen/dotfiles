...
function set-gnome-preferences
    ...
    dconf write /org/gnome/shell/favorite-apps "['org.gnome.Nautilus.desktop', 'brave-browser.desktop', 'org.gnome.Calculator.desktop', 'kitty.desktop', 'gpick.desktop', 'gparted.desktop', 'google-chrome.desktop',  'vlc.desktop', 'org.gnome.Settings.desktop', 'org.gnome.tweaks.desktop']"
